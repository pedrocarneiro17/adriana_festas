...
export default function NovoAgendaPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (tipo === "tarefa") {
      startTransition(async () => {
        await criarTarefa({ titulo, data: dataTarefa, eventoId: null, itens });
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-sm text-sand-600">Crie uma tarefa solta ou bloqueie uma data</p>
      </div>
      ...
      <div className="flex gap-3">
        ...
        >
          ...
          <span className="font-[family-name:var(--font-heading)] font-normal text-lg">Tarefa solta</span>
          <span className="text-sm opacity-80">Um lembrete com checklist, não vinculado a um evento</span>
        </button>
        <button
          type="button"
