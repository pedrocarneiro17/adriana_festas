...
async function main() {
  ...
  const [
    ...
    prisma.cliente.create({ data: { nome: "Mariana Souza", telefone: "(11) 98888-7777", email: "mariana@email.com", endereco: "Rua das Flores, 123", documento: "123.456.789-00" } }),
    prisma.cliente.create({ data: { nome: "Carla Mendes", telefone: "(11) 97777-1234", email: "carla.mendes@email.com", endereco: "Av. Paulista, 900" } }),
    prisma.cliente.create({ data: { nome: "Roberto Lima", telefone: "(11) 96666-5555", email: "roberto.lima@email.com" } }),
    prisma.cliente.create({ data: { nome: "Fernanda Alves", telefone: "(11) 95555-4444", email: "fernanda.alves@email.com", endereco: "Rua Augusta, 45" } }),
    prisma.cliente.create({ data: { nome: "João Pedro Santos", telefone: "(11) 94444-3333", email: "joaopedro@email.com" } }),
    prisma.cliente.create({ data: { nome: "Beatriz Rocha", telefone: "(11) 93333-2222", email: "beatriz.rocha@email.com" } }),
    prisma.cliente.create({ data: { nome: "Lucas Martins", telefone: "(11) 92222-1111", email: "lucas.martins@email.com", endereco: "Rua Oscar Freire, 210" } }),
    prisma.cliente.create({ data: { nome: "Patrícia Gomes", telefone: "(11) 91111-0000", email: "patricia.gomes@email.com" } }),
    prisma.cliente.create({ data: { nome: "Diego Ferreira", telefone: "(11) 90000-9999", email: "diego.ferreira@email.com" } }),
    prisma.cliente.create({ data: { nome: "Camila Barros", telefone: "(11) 98123-4567", email: "camila.barros@email.com" } }),
    prisma.cliente.create({ data: { nome: "Rafael Costa", telefone: "(11) 97123-4567", email: "rafael.costa@email.com" } }),
    prisma.cliente.create({ data: { nome: "Juliana Prado", telefone: "(11) 96123-4567", email: "juliana.prado@email.com", endereco: "Alameda Santos, 780" } }),
  ]);
